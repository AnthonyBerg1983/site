...
delete jStrings.locales["en"]
delete jStrings.locales["ru"]
delete jStrings.locales["he"]
delete jStrings.locales["pt"]
delete jStrings.locales["ar"]
delete jStrings.locales["ua"]
...
jsonUtils.update(jProfilePath, {
    ...
    locales: {
        en: {
            name: "Anthony Berg",
            credits: "Designed by <strong><a href='https://github.com/AnthonyBerg1983'>Anthony Berg</a></strong>",
            role: "Role"
        }
    },
    contactOptions: []
