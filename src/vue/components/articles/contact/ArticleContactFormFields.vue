...
span.input-group-attach {
    ...
    background-color: lighten(#0A9396, 1%);
    border-color: #005F73;
    color: $light-7;
}
...
/** ----------- PLACEHOLDERS ------------- **/
$input-placeholder-text-color: #0A9396;
...
.btn-submit {
  background-color: rgb(0, 95, 115) !important; /* teal background */
  border-color: rgb(0, 95, 115) !important;     /* match border */
  color: rgb(233, 216, 166) !important;         /* yellowish text/icon */
}

.btn-submit i {
  color: rgb(233, 216, 166) !important; /* make the FA icon yellowish */
}
</style>